...
Sept_date1 = "2019-09-01 00:00:00"
Sept_date2 = "2019-09-30 23:00:00"
...
a1 = round(np.mean(temp1),2)
b1 = round(np.mean(dewP1),2)
c1 = round(np.mean(hum1),2)
d1 = round(np.mean(wS1),2)
e1 = round(np.mean(wG1),2)
f1 = round(np.mean(press1),2)
g1 = round(np.mean(prec1),2)
...
a2 = round(np.mean(tempF1),2)
b2 = round(np.mean(dewPF1),2)
c2 = round(np.mean(humF1),2)
d2 = round(np.mean(wSF1),2)
e2 = round(np.mean(wGF1),2)
f2 = round(np.mean(pressF1),2)
g2 = round(np.mean(precF1),2)
...
a3 = round(np.mean(tempM1),2)
b3 = round(np.mean(dewPM1),2)
c3 = round(np.mean(humM1),2)
d3 = round(np.mean(wSM1),2)
e3 = round(np.mean(wGM1),2)
f3 = round(np.mean(pressM1),2)
g3 = round(np.mean(precM1),2)
...
a4 = round(np.mean(tempA1),2)
b4 = round(np.mean(dewPA1),2)
c4 = round(np.mean(humA1),2)
d4 = round(np.mean(wSA1),2)
e4 = round(np.mean(wGA1),2)
f4 = round(np.mean(pressA1),2)
g4 = round(np.mean(precA1),2)
...
a5 = round(np.mean(tempMa1),2)
b5 = round(np.mean(dewPMa1),2)
c5 = round(np.mean(humMa1),2)
d5 = round(np.mean(wSMa1),2)
e5 = round(np.mean(wGMa1),2)
f5 = round(np.mean(pressMa1),2)
g5 = round(np.mean(precMa1),2)
...
a6 = round(np.mean(tempJ1),2)
b6 = round(np.mean(dewPJ1),2)
c6 = round(np.mean(humJ1),2)
d6 = round(np.mean(wSJ1),2)
e6 = round(np.mean(wGJ1),2)
f6 = round(np.mean(pressJ1),2)
g6 = round(np.mean(precJ1),2)
...
a7 = round(np.mean(tempJu1),2)
b7 = round(np.mean(dewPJu1),2)
c7 = round(np.mean(humJu1),2)
d7 = round(np.mean(wSJu1),2)
e7 = round(np.mean(wGJu1),2)
f7 = round(np.mean(pressJu1),2)
g7 = round(np.mean(precJu1),2)
#
#August
...
a8 = round(np.mean(tempAu1),2)
b8 = round(np.mean(dewPAu1),2)
c8 = round(np.mean(humAu1),2)
d8 = round(np.mean(wSAu1),2)
e8 = round(np.mean(wGAu1),2)
f8 = round(np.mean(pressAu1),2)
g8 = round(np.mean(precAu1),2)
...
a9 = round(np.mean(tempS1),2)
b9 = round(np.mean(dewPS1),2)
c9 = round(np.mean(humS1),2)
d9 = round(np.mean(wSS1),2)
e9 = round(np.mean(wGS1),2)
f9 = round(np.mean(pressS1),2)
g9 = round(np.mean(precS1),2)
...
a10 = round(np.mean(tempO1),2)
b10 = round(np.mean(dewPO1),2)
c10 = round(np.mean(humO1),2)
d10 = round(np.mean(wSO1),2)
e10 = round(np.mean(wGO1),2)
f10 = round(np.mean(pressO1),2)
g10 = round(np.mean(precO1),2)
...
a11 = round(np.mean(tempN1),2)
b11 = round(np.mean(dewPN1),2)
c11 = round(np.mean(humN1),2)
d11 = round(np.mean(wSN1),2)
e11 = round(np.mean(wGN1),2)
f11 = round(np.mean(pressN1),2)
g11 = round(np.mean(precN1),2)
...
a12 = round(np.mean(tempD1),2)
b12 = round(np.mean(dewPD1),2)
c12 = round(np.mean(humD1),2)
d12 = round(np.mean(wSD1),2)
e12 = round(np.mean(wGD1),2)
f12 = round(np.mean(pressD1),2)
g12 = round(np.mean(precD1),2)
...
print(output)
output.to_excel(r'C:\Users\Adewole\Documents\Astra_Agric\Keffi_Weather4\KW2\2019_Mean.xlsx',index=False, header=True)
